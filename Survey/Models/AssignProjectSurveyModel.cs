...
namespace Survey.Models
{
    ...
    public class AssignSurveyMasterModel
    {
        ...
        public List<TotalSAReportModel> LsttotalSAReport { get; set; }
    ...
    public class TotalSAReportModel
    {
        public int TotalSARating { get; set; }
        public string SolutionArchetectName { get; set; }
        public int SA_IDCOUNT { get; set; }
        public int PS_Id { get; set; }
    }
